			...
			_1: {
				...
				_1: {
					...
					_1: {
						...
						_1: {
							ctor: '::',
							_0: ' There are simpler versions: *Html.beginnerProgram* and *Html.program*',
							_1: {ctor: '[]'}
						}
					}
				}
...
var _user$project$Presentation$tea6 = _xarvh$elm_slides$Slides$mdFragments(
	{
		ctor: '::',
		_0: '\n          ```text\n          Browser     Your code       Elm Runtime         Your code       World\n                                          |\n                                          m1\n                                          | < - - - - - - - - - - - HTTP Response\n                                          |\n                                          ----(msg m1)----> update\n                                                              |\n                                           <---(m2,Cmd msg)---\n                                          |\n                                          m2\n                                          |\n                       view <---(m2)------\n                         |\n                          --(Html msg)--->\n                                          |\n           render < - - - - - - - - - - - |\n                                          |\n                   subscriptions <--(m2)--\n                         |\n                          ---(Sub msg)--->\n                                          |\n                                          ~\n\n           ```\n           ',
		_1: {ctor: '[]'}
	});
var _user$project$Presentation$tea5 = _xarvh$elm_slides$Slides$mdFragments(
	{
		ctor: '::',
		_0: '\n          ```text\n          Browser     Your code       Elm Runtime         Your code       World\n                                          |\n                                          m0\n             - - - - - (click) - - - - >  |\n                                          ----(msg m0)----> update\n                                                              |\n                                           <---(m1,Cmd msg)---\n                                          |\n                                          m1\n                                          | - - - - - - - - - - - - - > HTTP Request\n                       view <---(m1)------\n                         |\n                          --(Html msg)--->\n                                          |\n           render < - - - - - - - - - - - |\n                                          |\n                   subscriptions <--(m1)--\n                         |\n                          ---(Sub msg)--->\n                                          |\n                                          ~\n\n           ```\n           ',
		_1: {ctor: '[]'}
	});
var _user$project$Presentation$tea4 = _xarvh$elm_slides$Slides$mdFragments(
	{
		ctor: '::',
		_0: '\n          ```text\n                             JS: Elm.Main.fullscreen(jsFlags);\n                                          |\n                                          |\n                                          v\n          Browser     Your code       Elm Runtime         Your code       World\n                                          |\n                                          -----(flags)-----> init\n                                                              |\n                                           <---(m0,Cmd msg)---\n                                          |\n                                          m0\n                                          |\n                       view <---(m0)------\n                         |\n                          --(Html msg)--->\n                                          |\n           render < - - - - - - - - - - - |\n                                          |\n                   subscriptions <--(m0)--\n                         |\n                          ---(Sub msg)--->\n                                          | - - - - - - - - - - - - -> eventHandler\n                                          ~\n\n           ```\n           ',
		_1: {ctor: '[]'}
	});
var _user$project$Presentation$tea3 = _xarvh$elm_slides$Slides$mdFragments(
	{
		ctor: '::',
		...
		_1: {
			...
			_1: {
				...
				_1: {
					ctor: '::',
					_0: '- optimized rendering via Virtual Dom',
					_1: {ctor: '[]'}
				}
			}
		}
	});
var _user$project$Presentation$tea2 = _xarvh$elm_slides$Slides$mdFragments(
	{
		ctor: '::',
		_0: '# TEA',
		_1: {
...
var _user$project$Presentation$tea1 = _xarvh$elm_slides$Slides$mdFragments(
	{
		ctor: '::',
		_0: 'It all sounds great but how do I make a web application???',
		_1: {ctor: '[]'}
	});
var _user$project$Presentation$patternmatching1 = _xarvh$elm_slides$Slides$md('This is also fundamental: Pattern Matching');
var _user$project$Presentation$uniontype4 = _xarvh$elm_slides$Slides$mdFragments(
	{
		ctor: '::',
		_0: 'The error types in Elm, Maybe and Result, are both Union types:',
		_1: {
			ctor: '::',
...
var _user$project$Presentation$uniontype3 = _xarvh$elm_slides$Slides$mdFragments(
	{
		ctor: '::',
		_0: 'Helper functions',
		_1: {
			ctor: '::',
			_0: '\n          ```elm\n          > Dog\n          <function> : String -> Repl.Size -> Repl.Animal\n          ```\n        ',
			_1: {
				ctor: '::',
				_0: 'refered to as a *tagger*',
				_1: {
					ctor: '::',
					_0: 'Records also have helpers',
					_1: {
						ctor: '::',
						_0: '\n          ```elm\n          > type alias Point = { x : Int, y : Int }\n          > Point\n          <function> : Int -> Int -> Repl.Point\n          ```\n        ',
						_1: {
							ctor: '::',
							_0: 'refered to as a *constructor*',
							_1: {ctor: '[]'}
						}
					}
				}
...
var _user$project$Presentation$uniontype1 = _xarvh$elm_slides$Slides$mdFragments(
	{
		ctor: '::',
		_0: '# Union Type',
		_1: {
			ctor: '::',
			_0: 'Like Tuple and Record but ...',
			_1: {
				ctor: '::',
				_0: 'Gather state flags and content validity into one',
				_1: {
					ctor: '::',
					_0: 'No Jigsaw analogy, but think of UNO',
					_1: {ctor: '[]'}
				}
			}
		}
...
var _user$project$Presentation$functions4 = _xarvh$elm_slides$Slides$mdFragments(
	{
		ctor: '::',
		_0: 'Other ways of constructing functions',
		_1: {
			ctor: '::',
			_0: 'Anonymous functions:',
			_1: {
				ctor: '::',
...
var _user$project$Presentation$functions3 = _xarvh$elm_slides$Slides$mdFragments(
	{
		ctor: '::',
		_0: 'Partial application of functions:',
		_1: {
			ctor: '::',
			...
			_1: {
				...
				_1: {
					ctor: '::',
					_0: '\n          ```elm\n          > String.repeat 5 \"Elm\"\n          \"ElmElmElmElmElm\" : String\n          ```\n          ',
					_1: {ctor: '[]'}
				}
			}
		}
	});
var _user$project$Presentation$functions2 = _xarvh$elm_slides$Slides$mdFragments(
	{
		ctor: '::',
		_0: 'Defining a function',
		_1: {
			ctor: '::',
			_0: '\n          ```elm\n          > hello name = \"Hello \" ++ name\n          <function> : String -> String\n          ```\n          ',
			_1: {
				ctor: '::',
				_0: 'Calling a function',
				_1: {
					ctor: '::',
					_0: '\n          ```elm\n          > hello \"Tom\"\n          \"Hello Tom\" : String\n          ```\n          ',
					_1: {
						...
						_1: {
							ctor: '::',
							_0: '\n          ```elm\n          > String.length (hello \"Paul\")\n          > \"Paul\" |> hello |> String.length\n          > String.length <| hello <| \"Paul\"\n          ```\n          ',
							_1: {ctor: '[]'}
						}
					}
				}
...
var _user$project$Presentation$functions1 = _xarvh$elm_slides$Slides$mdFragments(
	{
		ctor: '::',
		_0: '# Functions',
		_1: {
			ctor: '::',
			_0: '*Transform* your data from one type to another',
			_1: {
				ctor: '::',
				_0: 'they do not *do* anything',
				_1: {
					ctor: '::',
					_0: '\n          ```elm\n          > String.length \"abc\"\n          3 : Int\n          ```\n          ',
					_1: {
						...
						_1: {
							ctor: '::',
							_0: 'The filler pieces in a Jigsaw Puzzle',
							_1: {ctor: '[]'}
						}
					}
				}
...
var _user$project$Presentation$types3 = _xarvh$elm_slides$Slides$mdFragments(
	{
		ctor: '::',
		_0: '\':\' can be read as \'has type\'',
		_1: {
			ctor: '::',
			_0: 'types use **C**apitalized words',
			_1: {
				ctor: '::',
				_0: 'you can give names to types',
				_1: {
					ctor: '::',
...
var _user$project$Presentation$types2 = _xarvh$elm_slides$Slides$mdFragments(
	{
		ctor: '::',
		_0: 'Types can be combined to form new types',
		_1: {
			ctor: '::',
			_0: '\n        ```elm\n        List  -- elements with identical type\n\n        [ 1.0, 2.0, 3.0 ] : List Float\n        [ \"Hana\", \"Peter\", \"Susan\" ] : List String\n        ```\n        ',
			_1: {
				ctor: '::',
				_0: '\n        ```elm\n        Tuple  -- elements with different types\n\n        ( 8.5, \"Emma\", True ) : ( Float, String, Bool )\n        ```\n        ',
				_1: {
					ctor: '::',
					_0: '\n        ```elm\n        Record  -- named elements with different types\n\n        { x = 1.0, y = 2.0, label = \"X\" }\n         : { x : Float, y : Float, label : String }\n        ```\n        ',
					_1: {ctor: '[]'}
				}
			}
		}
	});
var _user$project$Presentation$types1 = _xarvh$elm_slides$Slides$mdFragments(
	{
		ctor: '::',
		_0: '# Types',
		_1: {
			ctor: '::',
			_0: 'Talk about the *shape* of your *data*',
			_1: {
				ctor: '::',
				_0: '\n          ```elm\n          -- Basic types\n\n          String, Int, Float\n          ```\n          ',
				_1: {
	...
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html_Attributes$class('lang-elm'),
					_1: {ctor: '[]'}
				},
				{
					ctor: '::',
...
var _user$project$Presentation$options = _elm_lang$core$Native_Utils.update(
	_xarvh$elm_slides$Slides$slidesDefaultOptions,
	{
		style: A4(
			...
			A3(_rtfeldman$elm_css$Css$rgb, 45, 45, 45)),
		animationDuration: 0.0
	});
var _user$project$Presentation$main = A2(
	_xarvh$elm_slides$Slides$app,
	_user$project$Presentation$options,
	{
		ctor: '::',
		_0: _user$project$Presentation$welcome,
		_1: {
			ctor: '::',
			_0: _user$project$Presentation$title,
			_1: {
				ctor: '::',
				_0: _user$project$Presentation$types1,
				_1: {
					ctor: '::',
					_0: _user$project$Presentation$types2,
					_1: {
						ctor: '::',
						_0: _user$project$Presentation$types3,
						_1: {
							ctor: '::',
							_0: _user$project$Presentation$functions1,
							_1: {
								ctor: '::',
								_0: _user$project$Presentation$functions2,
								_1: {
									ctor: '::',
									_0: _user$project$Presentation$functions3,
									_1: {
										ctor: '::',
...
if (typeof _user$project$Presentation$main !== 'undefined') {
    _user$project$Presentation$main(Elm['Presentation'], 'Presentation', undefined);
}
